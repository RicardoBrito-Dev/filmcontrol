...
export function QuotePdfView({ quote: initialQuote }: QuotePdfViewProps) {
  ...
  const whatsAppMessage = `Olá *${quote.customer?.name || 'Cliente'}*, segue o orçamento solicitado na *FILMCONTROL*:
            ...
            <div className="flex items-center gap-2.5">
              ...
              <div className="flex flex-col">
                ...
                <span className="text-[10px] text-muted-foreground uppercase tracking-widest">
                  Instalação de Películas Automotivas & Arquitetura
                </span>
              </div>
            </div>
            <p className="text-xs text-muted-foreground max-w-xs">
              Especialistas em proteção solar, conforto térmico e segurança.
            </p>
          </div>
        ...
        <div className="pt-12 grid grid-cols-2 gap-8 text-center text-xs text-muted-foreground">
          <div>
            <div className="border-t border-muted-foreground/40 pt-2 font-medium">
              FILMCONTROL — Instalação Profissional
            </div>
          </div>
          <div>
            <div className="border-t border-muted-foreground/40 pt-2 font-medium">
